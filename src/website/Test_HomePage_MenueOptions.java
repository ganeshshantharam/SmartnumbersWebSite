...
public class Test_HomePage_MenueOptions extends Common_Config  {
	  ...
	  @Test(priority=8)
	  public void solutionsMenue_overview() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void solutionsMenue_TwoNumbersOneMobile() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void solutionsMenu_CallRecording() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void solutionsMenu_FaceToFaceRecording() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void solutionsMenu_OfficeMoves() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void solutionsMenu_BusinessContinuity() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void products_Overview() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void products_SmartnumbersMobile() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void products_SmartnumbersCallRecording() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void products_SmartnumbersFaceToFaceRecording() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void products_SmartnumbersControl() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void partners_Overview() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void partners_DistributionPartners() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void partners_TechnologyPartners() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void AboutUs_Overview() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void AboutUs_Management() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void AboutUs_Careers() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void AboutUs_SocialResponsibility() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void AboutUs_News() throws InterruptedException
	  {
	  ...
	  @Test(priority=8)
	  public void AboutUs_Blog() throws InterruptedException
	  {
	...
	// File Menu - Resources
		  ...
		  @Test(priority=8)
		  public void AboutUs_Resources() throws InterruptedException
		  {
